...
const whatsappUrl = "https://wa.me/4917646647043?text=Hallo%20Selim";
  ...
  return (
    <>
      ...
      <a
        ...
        aria-label="WhatsApp Nachricht an Kansel senden"
        title="Über WhatsApp schreiben"
        className="fixed bottom-5 right-5 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_12px_30px_rgba(37,211,102,0.28)] transition-transform hover:-translate-y-1 focus-visible:outline-white sm:bottom-7 sm:right-7"
      >
